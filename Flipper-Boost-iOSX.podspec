Pod::Spec.new do |s|
    ...
    s.source       = { :git => "https://github.com/priteshrnandgaonkar/boost-iosx.git", :tag => "1.76.0.1.13" }
    s.module_name = 'boost'
    s.header_dir = 'boost'
    s.preserve_path = 'boost'
    s.vendored_frameworks = "frameworks/boost.xcframework"
